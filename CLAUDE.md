...
- **CI** (`.github/workflows/ci.yml`): Tests on Python 3.12-3.13, runs on every push/PR
...
```python
# Always check for collection → items structure
...
- Python 3.12+ required (modern Python with latest features)
